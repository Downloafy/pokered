...
ENDC
	...
	RGB 31,29,31, 24,20,30, 11,20,30, 31, 0, 0 ; PAL_0F
	RGB 31,29,31, 30,22,17, 16,14,19, 31, 0, 0 ; PAL_MEWMON
	RGB 31,29,31, 18,20,27, 11,15,23, 31, 0, 0 ; PAL_BLUEMON
	RGB 31,29,31, 31,20,10, 26,10,06, 31, 0, 0 ; PAL_REDMON
	RGB 31,29,31, 21,25,29, 14,19,25, 31, 0, 0 ; PAL_CYANMON
	RGB 31,29,31, 27,22,24, 21,15,23, 31, 0, 0 ; PAL_PURPLEMON
	RGB 31,29,31, 28,20,15, 21,14,09, 31, 0, 0 ; PAL_BROWNMON
	RGB 31,29,31, 20,26,16, 09,20,11, 31, 0, 0 ; PAL_GREENMON
	RGB 31,29,31, 30,22,24, 28,15,21, 31, 0, 0 ; PAL_PINKMON
	RGB 31,29,31, 31,28,14, 26,20,00, 31, 0, 0 ; PAL_YELLOWMON
	RGB 31,29,31, 26,21,22, 15,15,18, 31, 0, 0 ; PAL_GREYMON
	RGB 31,29,31, 26,21,22, 27,20,06, 31, 0, 0 ; PAL_SLOTS1
IF DEF(_RED)
